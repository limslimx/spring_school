...
public class SoccerService implements ISoccerService{
	...
	@Override
	public List<ResultDTO> getSoccerResult() throws Exception {

		log.info(this.getClass().getName()+".getSoccerResult start&end!");
		
		return soccerMapper.getSoccerResult();
	}

	@Override
	public int updateResultInfo(ResultDTO pDTO) throws Exception {

		log.info(this.getClass().getName()+".updateResultInfo start!");
		...
		while(rank.hasNext()) {
			...
			resultMapper.updateResultInfo(pDTO);
		}
		log.info(this.getClass().getName()+".updateResultInfo end!");
		return resultMapper.updateResultInfo(pDTO);
	}
