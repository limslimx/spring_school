			...
			<section class="hot-deal-area section-gap">
				<div class="container">					
					<div class="row justify-content-center">
						...
						<form method="post" action="/notiInfoModifyProc.do" style="width:100%">
							...
							<table border="1" style="width:100%;margin-bottom:5%">
								...
								<tr>
									...
									<td><input type="text" name="title" maxlength="100" style="width:100%" value="<%=nDTO.getTitle() %>"></td>
								</tr>
								<tr>
									<td colspan="2">
										<textarea name="content" style="width:100%;height:400px"><%=nDTO.getContent() %></textarea>
									</td>
								</tr>
							</table>
							<div align="center">
								<input type="submit" value="수정" class="btn btn-primary">
								<input type="button" onclick="location.href='/notiInfoDetail.do?seq=<%=nDTO.getSeq() %>'" value="뒤로" class="btn btn-primary">
							</div>
						</form>
