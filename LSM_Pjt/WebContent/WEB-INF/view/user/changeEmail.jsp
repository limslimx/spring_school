			...
			<section class="hot-deal-area section-gap">
				<div class="container">					
					<div class="row justify-content-center">	
						<form action="changeEmailProc.do" method="post" style="display:block">
							이메일: <input type="text" name="email" maxlength="100" style="width:100%" placeholder="변경할 이메일 입력"><br><br>
