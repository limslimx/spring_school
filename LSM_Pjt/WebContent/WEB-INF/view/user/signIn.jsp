				...
				<div class="container">					
					<div class="row justify-content-center">
                        <div class="tab-pane fade show active" id="flight" role="tabpanel" aria-labelledby="flight-tab">
                            <form name="f" method="post" action="/user/signInCheck.do" onsubmit="return doLoginUserCheck(this);" class="form-wrap">
                                <input type="text" class="form-control" name="user_id" placeholder="아이디" onfocus="this.placeholder = ''" onblur="this.placeholder = '아이디'"><br>							
                                <input type="password" class="form-control" name="password" placeholder="비번" onfocus="this.placeholder = ''" onblur="this.placeholder = '비번'"><br>				
